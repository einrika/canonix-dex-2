...
// Indexer Routes
router.get('/indexer/tokens', indexer.getIndexedTokens);
router.get('/indexer/token', indexer.getIndexedTokenDetail);
router.get('/indexer/index-wallet', indexer.triggerWalletIndex);

                ...
                <div class="lg:col-span-2 space-y-12">
                        ...
                        <div class="p-8 space-y-10">
                            <div class="space-y-4">
                                ...
                                <div class="grid grid-cols-2 gap-6">
                                    <button onclick="SettingsPage.updateConfig('network', 'mainnet')" class="p-6 border-4 ${this.config.network === 'mainnet' ? 'border-meme-green bg-meme-green text-black shadow-brutal-green' : 'border-card bg-bg text-muted-text shadow-brutal'} font-display text-2xl uppercase italic transition-all">
                                        MAINNET
                                    </button>
                                    <button onclick="SettingsPage.updateConfig('network', 'testnet')" class="p-6 border-4 ${this.config.network === 'testnet' ? 'border-meme-pink bg-meme-pink text-primary-text shadow-brutal-pink' : 'border-card bg-bg text-muted-text shadow-brutal'} font-display text-2xl uppercase italic transition-all">
                                        TESTNET
                                    </button>
                                </div>
                            </div>
                    ...
                    <div class="bg-surface border-4 border-card shadow-brutal-lg overflow-hidden rotate-[-0.5deg]">
                        <div class="p-8 border-b-4 border-card bg-bg flex items-center gap-4">
                            ...
                            <h3 class="text-4xl font-display text-primary-text italic uppercase tracking-tighter">AI BRAIN STEM</h3>
                        </div>
                        <div class="p-8 space-y-10">
                            <div class="flex items-center justify-between p-6 bg-surface border-4 border-card shadow-brutal">
                                <div>
                                    <h4 class="font-display text-2xl text-primary-text italic uppercase">Bionic Insights</h4>
                                    <p class="font-mono text-[9px] text-muted-text font-bold uppercase">Activate Gemini-PRO consciousness</p>
                                </div>
                                <button onclick="SettingsPage.updateConfig('aiEnabled', ${!this.config.aiEnabled})" class="w-16 h-8 rounded-full border-2 border-card ${this.config.aiEnabled ? 'bg-meme-green' : 'bg-gray-800'} relative transition-all shadow-brutal">
                                    <div class="absolute top-1 ${this.config.aiEnabled ? 'right-1' : 'left-1'} w-5 h-5 bg-white border-2 border-card rounded-full transition-all"></div>
                                </button>
                            </div>
                    ...
                    <div class="bg-surface border-4 border-card shadow-brutal-lg overflow-hidden rotate-[1deg]">
                        <div class="p-8 border-b-4 border-card bg-bg flex items-center gap-4">
                            ...
                            <h3 class="text-4xl font-display text-primary-text italic uppercase tracking-tighter">FIREWALL OPS</h3>
                        </div>
                        <div class="p-8 space-y-10">
                            <div class="space-y-4">
                            ...
                            <div class="flex items-center justify-between p-6 bg-surface border-4 border-card shadow-brutal">
                                <div>
                                    <h4 class="font-display text-2xl text-primary-text italic uppercase">Giga Mode</h4>
                                    <p class="font-mono text-[9px] text-muted-text font-bold uppercase">Exposure of technical log streams</p>
                                </div>
                                <button onclick="SettingsPage.updateConfig('advancedMode', ${!this.config.advancedMode})" class="w-16 h-8 rounded-full border-2 border-card ${this.config.advancedMode ? 'bg-meme-green' : 'bg-gray-800'} relative transition-all shadow-brutal">
                                    <div class="absolute top-1 ${this.config.advancedMode ? 'right-1' : 'left-1'} w-5 h-5 bg-white border-2 border-card rounded-full transition-all"></div>
                                </button>
                            </div>
                        </div>
                    </div>
